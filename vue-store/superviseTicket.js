...
from '@/constant/store'
import * as Service from '@/service/superviseTicket'
...
const queryMTS = SuperviseTicketSTS.mutations.query
const queryATS = SuperviseTicketSTS.actions.query
...
const queryMutations = {
  ...
  //更新处理记录
  [queryMTS.updateDescriptionRecordH5Html](state, descriptionRecordH5Html) {
    state.descriptionRecordH5Html = descriptionRecordH5Html
  }
}
